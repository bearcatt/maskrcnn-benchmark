...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("global_roi_pool_forward", &GlobalROIPool_forward, "GlobalROIPool_forward");
  m.def("global_roi_pool_backward", &GlobalROIPool_backward, "GlobalROIPool_backward");
